export default [
  ...
  },
  {
    ...
    type: 'function',
    constant: true,
    signature: '0x9abc8320',
  },
  {
    inputs: [{ internalType: 'uint256', name: '_playerId', type: 'uint256' }],
    name: 'burn',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
